...
/**
 * Class is used for sorting competitors by stop descending.
 * 
 * @author Kevari Francis & Chris Harmon
 */
@SuppressWarnings("serial")
public class StopDescending extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if ( !results.isEmpty() ) {
			...
			message = Participant.ReverseSortByFinish(message);
		}
		...
		String table = "<head><link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\"></head>" +
				...
				"<th><a href=\"stopascending\"> FINISH </a></th>" +
