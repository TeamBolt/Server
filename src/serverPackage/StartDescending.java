...
/**
 * Class is used for sorting competitors by start descending.
 * 
 * @author Kevari Francis & Chris Harmon
 */
@SuppressWarnings("serial")
public class StartDescending extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if ( !results.isEmpty() ) {
			...
			message = Participant.ReverseSortByStart(message);
		}
		...
		String table = "<head><link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\"></head>" +
				...
				"<th><a href=\"startascending\"> START </a></th>" +
