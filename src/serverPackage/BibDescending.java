...
/**
 * Class is used for sorting competitors by bib descending.
 * 
 * @author Kevari Francis & Chris Harmon
 */
@SuppressWarnings("serial")
public class BibDescending extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if ( !results.isEmpty() ) {
			...
			message = Participant.ReverseSortByBib(message);
		}
		...
		String table = "<head><link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\"></head>" +
				...
				"<tr>" +
				"<th> RUN </th>" +
				"<th><a id='bibs' href=\"bibascending\"> BIB </a></th>" +
